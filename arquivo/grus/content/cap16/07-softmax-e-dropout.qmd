...
É a escada da [seção 16.6](06-outras-funcoes-de-ativacao.qmd) de novo, invertida: lá a perda ficava presa em patamares enquanto o acerto não se mexia; aqui a perda desce reto e é o acerto que afunda antes de subir. Nos dois casos, a métrica que interessa passa um bom tempo sem mostrar o progresso que está acontecendo.
...
Cabe aqui uma franqueza: o dropout aparece **sem nenhuma medição de que ele serve**. Com três passadas em 10.000 imagens, a rede da [seção 16.8](08-exemplo-mnist.qmd) fecha com 0,9020 de acerto no treino contra 0,8815 no teste: ela ainda não sobreajusta nada, e portanto o dropout ali não tem o que consertar. Demonstrar o benefício exigiria uma comparação com e sem, sobre um treino longo o bastante para a rede sobreajustar — e treino é justamente o que custa caro nesta biblioteca. O que dá para observar é o **comportamento** do dropout: a saída que muda entre treino e avaliação, e o prejuízo de esquecer de desligá-lo.
...
**A saída passa a ser aleatória durante o treino.** Duas chamadas de `forward` com a mesma entrada devolvem coisas diferentes, porque a máscara é sorteada de novo. Repetir uma passada exige fixar a semente antes dela.
