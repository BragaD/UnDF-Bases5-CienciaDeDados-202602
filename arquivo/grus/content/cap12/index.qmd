...
📓 [**Abrir o notebook deste capítulo no Colab ↗**](https://colab.research.google.com/github/BragaD/UnDF-Bases5-CienciaDeDados-202602/blob/main/notebooks/cap12-regressao-multipla.ipynb) — só o código, pronto para rodar.
...
Agora estão. Sabemos também quantas horas por dia cada usuário trabalha e se ele tem doutorado. Este capítulo estende o modelo de uma variável explicativa para várias, e a extensão é quase indolor: o `predict` vira um produto escalar, o gradiente vira um vetor com um componente por coeficiente, e o gradiente descendente do [Capítulo 5](../cap05/index.qmd) continua funcionando sem uma linha de mudança. O R² sobe de 0,33 para 0,68.
