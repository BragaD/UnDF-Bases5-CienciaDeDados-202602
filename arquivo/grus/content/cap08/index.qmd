...
📓 [**Abrir o notebook deste capítulo no Colab ↗**](https://colab.research.google.com/github/BragaD/UnDF-Bases5-CienciaDeDados-202602/blob/main/notebooks/cap08-machine-learning.ipynb) — só o código, pronto para rodar.
...
- Dividir dados em treino e teste — de um array ou de uma tabela — e explicar por que uma divisão em duas partes às vezes não basta
- Construir uma matriz de confusão com linhas e colunas nomeadas, e calcular acurácia, precisão, revocação e F1
