...
```{python}
#| label: fig-curvatura
#| fig-cap: "MSE de teste da reta e do melhor k-NN de cada nível (o menor entre os nove k varridos acima), contra a curvatura da verdade simulada. A reta piora conforme a curvatura cresce; o k-NN quase não se mexe. A faixa sombreada marca onde a curva da reta cruza a do k-NN, entre as curvaturas testadas."
fig, ax = plt.subplots()
