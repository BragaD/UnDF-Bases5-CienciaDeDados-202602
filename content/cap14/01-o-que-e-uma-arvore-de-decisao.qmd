...
- O classificador improvisado da [seção 1.3](../cap01/03-hipotese-motivadora-datasciencester.qmd) — `if anos < 3.0 ... elif anos < 8.5 ...` — parece a exceção, porque se lê numa olhada. Mas ninguém o **ajustou**: os cortes foram escolhidos à mão, lidos do gráfico dos próprios dados que ele deveria explicar. O que se lê ali não é conhecimento sobre o mundo — é o conjunto de treino decorado, o defeito que o [Capítulo 8](../cap08/index.qmd) batizou. Legibilidade sem aprendizado não é o que este capítulo promete.
