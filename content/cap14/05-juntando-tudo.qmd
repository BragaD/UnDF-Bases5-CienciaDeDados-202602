...
::: {.callout-important}
Como o objetivo aqui era demonstrar **como** construir uma árvore, nós a construímos sobre o conjunto de dados inteiro. Como sempre, se estivéssemos realmente tentando criar um bom modelo para alguma coisa, teríamos coletado mais dados e os dividido em subconjuntos de treino, validação e teste — como a [seção 8.3](../cap08/03-overfitting-e-underfitting.qmd) insistiu.
