...
A escolha da base não muda qual conjunto tem mais entropia que qual — trocar a base multiplica todos os valores pela mesma constante. O que a base 2 dá é uma **unidade interpretável**: o **bit**, a resposta de uma pergunta de sim/não.

Lida assim, a entropia é o número médio de perguntas de sim/não necessárias para descobrir a classe de um elemento sorteado do conjunto, se você fizer as perguntas do jeito mais esperto possível:
