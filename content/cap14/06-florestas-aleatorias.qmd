...
Guarde o tamanho disso: o padrão da biblioteca ficou 1,1 ponto percentual abaixo do melhor valor que medimos, num problema pequeno e sem nada escondido. A "recomendação clássica" $\sqrt{p}$ para classificação é uma regra de bolso boa o bastante para começar, não um ótimo — e `max_features` é justamente um dos primeiros parâmetros a varrer quando o último ponto percentual importa.
