...
Todos os quatro reduzem a incerteza inicial de 0,940 bit — nenhum atributo é puro ruído aqui. Mas o menor de todos, e portanto o vencedor, é `level`: particionar os candidatos por senioridade deixa a incerteza média em **0,694 bit**, uma redução de cerca de 0,247 bit.

Dá para ver por quê olhando a partição:
...
#| fig-cap: "Entropia da partição por atributo. A linha tracejada é a entropia antes de perguntar qualquer coisa; a barra verde é o atributo vencedor."
#| echo: false
...
O `id` vence, com folga, e por goleada: **0,000000** contra os 0,694 do `level`. Pelo critério que acabamos de escrever, o número de matrícula é o melhor preditor de desempenho em entrevista de que dispomos.
...
Isso não é uma peculiaridade de um dataset de brinquedo. É a mesma classe de erro do classificador do [Capítulo 1](../cap01/index.qmd) que lia os cortes de idade dos próprios dados que deveria explicar — e a mesma coisa que um identificador de usuário, um carimbo de tempo com precisão de milissegundo ou um número de pedido fazem, discretamente, com qualquer modelo em que entrem por acidente.
:::
