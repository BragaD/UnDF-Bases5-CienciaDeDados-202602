...
Nenhum dos dois **resolve** o problema; os dois o tornam menos provável. O atributo `inertia_` do modelo ajustado guarda exatamente a soma de distâncias ao quadrado que a [seção 17.4](04-escolhendo-k.qmd) vai calcular à mão — e é por essa soma que `n_init` escolhe o melhor, quando você o liga.
:::
