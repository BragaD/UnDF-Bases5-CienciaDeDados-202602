...
Todos os modelos que você construiu até aqui tinham uma resposta certa em algum lugar. A flor era *setosa*, *versicolor* ou *virginica*. O e-mail era spam ou não era. O usuário passava tantos minutos por dia no site. O dígito escrito à mão era um 7. Em cada caso, alguém — um botânico, um usuário que apertou "marcar como spam", um relógio, uma pessoa que olhou a imagem e digitou o número — já tinha respondido à pergunta antes, e o modelo aprendeu a imitar essa resposta.
