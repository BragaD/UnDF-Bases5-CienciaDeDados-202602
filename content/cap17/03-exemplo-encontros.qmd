...
Os centros não saem idênticos aos nossos, porque a inicialização é outra: o `scikit-learn` espalha os centros iniciais com `k-means++` e roda o algoritmo dez vezes, ficando com o melhor resultado, enquanto o nosso `train` aceita o primeiro ótimo local que encontrar — o callout da [seção 17.2](02-o-modelo.qmd) detalha os dois mecanismos.
