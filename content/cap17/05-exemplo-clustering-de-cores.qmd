...
Na máquina em que este capítulo foi escrito, esse `train` levou cerca de **16 segundos**. O número fica na prosa de propósito: cronometrá-lo dentro do chunk publicaria um valor diferente a cada renderização e em cada computador — exatamente o ruído que a semente fixa existe para evitar neste livro. E o que importa não é o valor, é a ordem de grandeza: segundos, não milissegundos, para percorrer 355.200 listas de três elementos a cada iteração.
