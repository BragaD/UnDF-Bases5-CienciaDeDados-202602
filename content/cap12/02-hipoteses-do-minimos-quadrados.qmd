...
Para colinearidade **exata**, o `scikit-learn` não reclama: `LinearRegression` resolve o sistema por decomposição em valores singulares, que devolve a solução de norma mínima em vez de estourar. Você recebe um `beta` bonito, sem aviso nenhum, e ele é o representante de **norma mínima** da infinidade de empatados — o que reparte o coeficiente igualmente entre as duas colunas (0,4863 + 0,4863), sem que nada nos dados justifique essa partilha mais do que as três que vimos acima.
