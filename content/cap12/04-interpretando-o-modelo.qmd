...
`least_squares_fit` não é redefinida aqui: vem de `scratch_np.multiple_regression`, o mesmo código da [seção anterior](03-ajustando-o-modelo.qmd), e o ajuste é refeito com a mesma semente — os quatro números abaixo são os mesmos de lá.
