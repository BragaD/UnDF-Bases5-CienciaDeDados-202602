...
A curva tem a mesma forma da do capítulo anterior — dois patamares e duas quedas —, o que já é informativo: trocar a ativação, o otimizador e a representação inteira não fez o platô desaparecer. Ele não é um artefato do código; é uma propriedade do problema.
