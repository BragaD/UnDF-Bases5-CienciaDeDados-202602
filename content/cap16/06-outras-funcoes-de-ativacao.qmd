...
Aqui rodamos 300. O motivo está impresso acima: um epoch custa cerca de 0,12 segundo nesta biblioteca, então 1.000 epochs custariam **dois minutos** de renderização — e este livro é renderizado por inteiro, do zero, a cada publicação, com o cache de execução apagado de propósito para provar que nada vem da rede. Trezentos epochs custam menos de 40 segundos e chegam perto o suficiente do resultado do livro-texto para o argumento ficar de pé.
