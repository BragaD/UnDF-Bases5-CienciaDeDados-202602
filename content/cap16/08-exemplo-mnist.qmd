...
Falta um capítulo, e repare no que esta seção precisou para existir: a tabela de confusões acima só pôde ser montada porque, para cada uma das dez mil imagens de teste, alguém já tinha escrito qual dígito era. O [Capítulo 17](../cap17/index.qmd) trabalha sem essa coluna — e é a última coisa que este livro constrói.
:::
