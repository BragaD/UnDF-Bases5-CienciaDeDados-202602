...
Falta um capítulo, e ele tira o chão de tudo isto. Da primeira página do livro até esta última tabela de confusões, sempre houve um gabarito contra o qual comparar: a flor era *setosa*, o e-mail era spam, o dígito era um 7 — e "funcionou" pôde sempre significar "acertou". O [Capítulo 17](../cap17/index.qmd) recebe dados sem rótulo nenhum e precisa descobrir que grupos existem neles. Sem gabarito não há acurácia, nem conjunto de teste, nem nada do vocabulário que o [Capítulo 8](../cap08/index.qmd) construiu para julgar um modelo. A pergunta que sobra é bem mais desconfortável, e bem mais parecida com o trabalho de verdade.
:::
