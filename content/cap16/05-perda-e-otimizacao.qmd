...
As duas curvas contam a mesma história com ritmos diferentes: um trecho longo e quase plano, uma descida abrupta, e o zero. O platô é o mesmo fenômeno que a [seção 15.4](../cap15/04-exemplo-fizz-buzz.qmd) documentou no Fizz Buzz — a rede fica presa numa região de gradiente minúsculo antes de escapar. O momento não elimina o platô; ele o encurta.
...
Repare, aliás, que a saída agora é exatamente 0,0000 e 1,0000. Sem a sigmoide final, a saída da rede não está mais presa em $[0, 1]$, e a perda quadrática pode de fato chegar a zero, coisa que uma sigmoide nunca permitiria.
:::
