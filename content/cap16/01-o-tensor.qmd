...
Essa é a justificativa do livro-texto, e vale dizer desde já que ela não é a nossa: **este livro nunca passa de duas dimensões.** As imagens do MNIST da [seção 16.8](08-exemplo-mnist.qmd) chegam achatadas em 784 números, e o maior objeto que qualquer página aqui manipula é uma matriz. A generalidade ainda paga — só que por outro motivo, que aparece no fim desta seção.
