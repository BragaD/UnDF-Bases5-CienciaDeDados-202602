...
- *Deep Learning with Python*, de François Chollet (Manning), é uma introdução ao **Keras** — a biblioteca em que a biblioteca deste capítulo é vagamente inspirada. Se a estrutura de `Layer`, `Sequential` e `Optimizer` pareceu familiar, é por isso.
