...
round(media_prob_estudante, 6), round(media_prob_nao_estudante, 6)
```

A média da probabilidade que o modelo múltiplo prevê para cada estudante, sobre o saldo e a renda que ele de fato tem, é 0,043139; a mesma média entre não estudantes é 0,029195 — batem, até a sexta casa decimal, com os 4,31% e 2,92% de taxa bruta do começo desta seção.
