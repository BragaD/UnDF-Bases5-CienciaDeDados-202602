...
#| fig-cap: "Distribuição do erro de teste em 200 sorteios de treino, para os seis classificadores, nos três cenários simulados (painéis, cada um com sua própria escala de erro). Em laranja, o classificador com menor erro médio naquele cenário — calculado do próprio dado, não escrito à mão; em azul, os demais. A cor marca só essa distinção; a identidade de cada classificador está no rótulo do eixo."
