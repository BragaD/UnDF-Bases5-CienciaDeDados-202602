...
Isso é proposital, e é assim que @grus2019 abre o livro dele. A intenção não é que você escreva este código agora, e sim que veja o formato do trabalho antes de aprender as ferramentas: que tipo de pergunta se faz, que tipo de resposta se obtém, e quão pouco código separa uma da outra.
...
Existem noções de centralidade que capturam isso melhor, e elas são o assunto do capítulo 22 de @grus2019. **Esse capítulo está fora do escopo desta disciplina** — fica como leitura para quem se interessar.
:::
...
Com isso daria para construir um sugeridor mais rico, combinando amigos em comum e interesses em comum. Esse tipo de aplicação é o assunto do capítulo 23 de @grus2019 — **também fora do escopo desta disciplina.**
...
Tratar texto de forma menos ingênua é assunto do capítulo 21 de @grus2019, **fora do escopo desta disciplina**. O que vale registrar aqui é que a decisão de quebrar por espaço não foi neutra: ela mudou a resposta.
:::
