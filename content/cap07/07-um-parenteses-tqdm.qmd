...
::: {.callout-note}
O chunk acima roda com `#| warning: false`. `tqdm` escreve a barra de progresso no fluxo de erro padrão (`stderr`), atualizando a mesma linha repetidamente — útil ao acompanhar ao vivo num terminal, mas repetitivo quando um notebook captura esse fluxo inteiro como saída de célula. A mesma opção reaparece no [Capítulo 9](../cap09/03-a-maldicao-da-dimensionalidade.qmd), pela mesma razão.
:::
