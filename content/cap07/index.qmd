...
🎛️ [**Flexibilidade e erro ↗**](../../apoio/flexibilidade-e-erro.html) — a página interativa da aula: mova a flexibilidade de um ajuste e veja o MSE de treino cair enquanto o de teste desenha a curva em U, com viés², variância e Var(ε) somando o erro de teste a cada passo — e troque a `f` verdadeira para ver o mínimo mudar de lugar.
