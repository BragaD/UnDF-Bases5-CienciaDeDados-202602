...
grau_minimo_loocv, salto_grau_1_para_2, amplitude_graus_2_a_10
```

A reta erra 24,23; a parábola, 19,25, e o erro cai 4,98 de um grau para o outro. Do grau 2 ao grau 10, as nove estimativas cabem numa faixa de 0,66. O menor MSE da LOOCV cai no grau 7, com 18,83, como aponta o `np.argmin`, mas a diferença para a parábola é pequena perto do salto que a curvatura já deu.
