...
Isso leva cerca de um minuto — 500 epochs sobre 923 exemplos, com uma passada para a frente e uma para trás em cada um, tudo em Python puro sobre listas. É de longe o código mais caro deste capítulo, e o preço é o mesmo de sempre: transparência.
...
Essa configuração é a mais próxima da nossa: 25 neurônios escondidos, ativação logística. Rodando isso (`scikit-learn` 1.9), ela devolve **0,53** — e `rede.n_iter_` mostra por quê: o treino parou na **iteração 51**.
