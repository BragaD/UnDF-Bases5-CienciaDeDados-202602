...
Repare no que está sendo lido aí, porque é fácil ler a coisa errada. Não é o acerto no treino: acertar muito — ou até tudo — no próprio treino não é, sozinho, sinal de nada, nem bom nem ruim. O que se lê é a **distância** entre treino e teste, e a [seção 14.6](../cap14/06-florestas-aleatorias.qmd) mostrou o caso extremo disso: lá a árvore sem poda acertava 99,7% dos exemplos com que se construiu e caía para 82,4% em dados novos, enquanto a árvore de profundidade 2, **pior** no treino com 85,0%, acertava 100% do teste. O modelo com o melhor número de treino era o pior dos dois.
