...
Quem procurar com afinco acha fragmentos: os pesos dos bits 0, 4 e 8 saem quase iguais entre si nos dois vetores, e esses três bits são de fato intercambiáveis neste problema, porque $2^0$, $2^4$ e $2^8$ deixam o mesmo resto na divisão por 15. É informação real, e ainda assim não é uma resposta: saber que o neurônio trata três bits como equivalentes não diz o que ele responde, nem por quê.
