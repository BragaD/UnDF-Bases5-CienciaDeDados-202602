...
O `bias` é um deslocamento: ele decide *quão grande* a soma ponderada precisa ser para o neurônio disparar. O `dot` é o produto escalar do [Capítulo 4](../cap04/index.qmd), e é ele que faz todo o trabalho.
...
```{python}
#| label: fig-portas
#| fig-cap: "Os quatro pontos de entrada, para as portas E, OU e XOR. Preenchido = a porta devolve 1."
#| echo: false
...
E o XOR? A biblioteca não avisa nada. Ela ajusta, devolve um modelo, e o modelo tem `coef_ = [[0., 0.]]` e `intercept_ = [0.]` — o vetor de pesos zerado. As correções que a regra de treino aplica a cada passagem se cancelam exatamente sobre os quatro pontos, e o que sobra é um classificador degenerado, que responde 0 para tudo e acerta 2 dos 4 pontos: acurácia de 0,5.
