...
Nenhum dos três interrompe nada. O código de @grus2019, com `math.log`, receberia um `ValueError: math domain error` no ponto 1 e pararia ali: barulhento, feio e **impossível de ignorar**. Em `numpy` a mesma conta produz três avisos e segue. Trocar a exceção pelo aviso é o preço da vetorização, e é um preço que quase todo código científico paga sem perceber que pagou.
:::
