...
Agora o ajuste, com o `least_squares_fit` do capítulo anterior, sem uma linha de mudança — e com o `#| warning: false` que a [seção 12.3](../cap12/03-ajustando-o-modelo.qmd) explica, porque `least_squares_fit` usa `tqdm` por dentro:
