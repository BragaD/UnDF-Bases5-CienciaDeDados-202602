...
O código acima é literalmente o do Grus, buscando os repositórios da própria conta dele (`joelgrus`) — não a do time de engenharia da DataSciencester do parágrafo anterior. Para apontar isso a outra organização, basta trocar o valor de `github_user`.
