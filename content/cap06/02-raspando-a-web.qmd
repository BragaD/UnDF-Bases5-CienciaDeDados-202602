...
Nenhuma das duas muda a lição central: o dado bruto de uma página raspada é HTML mal formado, e alguma coisa — `BeautifulSoup` ou o que quer que você use — vai ter que impor uma estrutura em cima dele antes que a informação vire algo utilizável. E essa estrutura, quase sempre, é uma tabela: a raspagem termina onde a [seção 6.1](01-lendo-arquivos.qmd) começou.
:::
