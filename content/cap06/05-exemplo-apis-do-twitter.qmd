...
O Grus ensina a acessar a API do Twitter com a biblioteca `twython` e credenciais gratuitas de desenvolvedor — nenhuma das duas existe mais do jeito que o livro descreve. Diferente da raspagem do Congresso ou da API do GitHub, não há aqui uma URL para trocar: o serviço que a seção ensina a acessar não é mais o mesmo serviço. Nenhum código desta seção é executado; tudo aparece como ilustração.
:::
