...
Pernambuco é o sétimo mais populoso das 27 unidades, com população acima do dobro da mediana. A correlação — um número entre −1 e 1 que resume o quanto duas variáveis crescem juntas, com 0 indicando nenhuma relação linear entre elas — entre as duas colunas dá um primeiro número para o que o olho já viu:
