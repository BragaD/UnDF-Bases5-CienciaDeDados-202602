...
Pernambuco, com população intermediária, tem a maior taxa da tabela, 36,78. A correlação entre as duas colunas confirma o que o olho já viu:
...
-0,41 é uma correlação fraca — negativa o bastante para não ser acaso, fraca demais para virar regra. São Paulo e Minas Gerais puxam essa tendência sozinhos, no topo da população; o resto da distribuição não a repete. Separar os estados por região, o que agrupar e resumir faz na seção 6.5, é o próximo passo para procurar o que de fato explica a variação — população isolada não é essa resposta.
