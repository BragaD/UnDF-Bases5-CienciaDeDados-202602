...
O `dados/iris.data` do [Capítulo 9](../cap09/02-exemplo-o-dataset-iris.qmd) tem exatamente este formato — quatro medidas por linha e um rótulo de texto no fim —, a mesma mistura de número e texto que este `csv.reader` resolve, só que os campos são medidas de flor em vez de preços de ação.
