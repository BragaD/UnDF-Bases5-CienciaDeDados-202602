...
Consequência prática dessa escada: além da regra geral deste livro — que é renderizado com a rede desligada, de propósito —, várias seções trazem código que não executa de verdade por um motivo específico daquela seção. A caixa ao lado de cada um explica qual é.
