...
Consequência prática dessa escada: várias seções trazem código que não executa de verdade neste livro — cada um por um motivo específico daquela seção, não porque este material proíba rede em geral. A caixa ao lado de cada um explica qual é.
