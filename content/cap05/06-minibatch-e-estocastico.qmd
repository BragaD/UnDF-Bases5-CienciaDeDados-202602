...
`gradient_step` e `linear_gradient` já foram escritas nas seções [5.3](03-usando-o-gradiente.qmd) e [5.5](05-ajustando-modelos.qmd); `vector_mean` vem do [Capítulo 4](../cap04/01-vetores.qmd):
