...
`gradient_step` e `sum_of_squares_gradient` já foram escritas na [seção anterior](03-usando-o-gradiente.qmd). Em vez de reescrevê-las, importamos:
...
::: {.callout-note}
## Por que importar, e não reescrever
