...
Vamos chamar os parâmetros de `theta` (θ) — a convenção deste livro, e de quase todo texto de aprendizado de máquina, para "o vetor de parâmetros do modelo, sejam eles quais forem". Os capítulos 11 a 13 herdam o mesmo nome; aqui, `theta` guarda inclinação e intercepto.
