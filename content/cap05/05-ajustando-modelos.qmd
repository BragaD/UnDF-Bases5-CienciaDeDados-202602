...
`gradient_step` já foi escrita na [seção 5.3](03-usando-o-gradiente.qmd), e `vector_mean` vem do [Capítulo 4](../cap04/01-vetores.qmd) — a média componente a componente de uma lista de vetores:
