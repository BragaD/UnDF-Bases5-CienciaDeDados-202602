...
📓 [**Abrir o notebook deste capítulo no Colab ↗**](https://colab.research.google.com/github/BragaD/UnDF-Bases5-CienciaDeDados-202602/blob/main/notebooks/cap05-gradiente-descendente.ipynb) — só o código, pronto para rodar.

🎛️ [**Gradiente passo a passo ↗**](../../apoio/gradiente-descendente.html) — a página interativa da aula: escolha a função, mexa no tamanho do passo e veja a derivada, o passo e o rastro a cada iteração, com uma variável ou com duas.

🏁 [**Lote, minibatch, estocástico ↗**](../../apoio/lote-minibatch-estocastico.html) — os três métodos da [seção 5.6](06-minibatch-e-estocastico.qmd) treinando lado a lado, no mesmo orçamento de chamadas a `gradient_step`, com a perda e a reta ajustada ao vivo.
