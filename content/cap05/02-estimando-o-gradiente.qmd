...
Uma cópia do código do livro-texto que mora dentro deste repositório (`scratch/gradient_descent.py`) também define `estimate_gradient`, mas lá `partial_difference_quotient` vive dentro de uma função de demonstração e não é visível fora dela — importar funciona, chamar estoura com `NameError`. Por isso escrevemos as duas por conta própria aqui; a [seção 5.4](04-escolhendo-o-tamanho-do-passo.qmd) explica como o resto do capítulo reaproveita código entre seções.
