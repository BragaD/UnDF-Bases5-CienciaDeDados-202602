...
Que você conhece arranjos, listas, tabelas hash e conjuntos como estruturas. O que muda: a sintaxe de fatiamento e desempacotamento. **O que vale desacelerar: `defaultdict` e `Counter`** — juntos aparecem 85 vezes no código do livro, e substituem laços de contagem que você provavelmente escreveria à mão.
:::
...
Você já viu esse padrão duas vezes neste livro sem que ele fosse nomeado: no [Capítulo 1](../cap01/index.qmd), montando o índice de interesses por usuário e o de usuários por interesse; e no [Capítulo 8](../cap08/index.qmd), agrupando salários por faixa de tempo de casa.

Sempre que você for escrever "para cada X, junte os Y correspondentes", é `defaultdict(list)`.
:::

## `Counter` — 47 usos no livro
