...
Este é o primeiro exemplo de um hábito que atravessa o livro inteiro: **o código do @grus2019 anota tipos em 168 das suas 259 funções.** Vale se acostumar.
:::
...
::: {.callout-important}
## O `assert` é a documentação deste livro
