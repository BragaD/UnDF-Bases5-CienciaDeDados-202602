...
📓 [**Abrir o notebook deste capítulo no Colab ↗**](https://colab.research.google.com/github/BragaD/UnDF-Bases5-CienciaDeDados-202602/blob/main/notebooks/cap04-algebra-linear.ipynb) — só o código, pronto para rodar.
...
O que este capítulo constrói é pequeno: um punhado de funções sobre listas de números. O que ele entrega é a base sobre a qual quase todo o resto do livro se apoia. A função `dot`, que cabe em duas linhas, é usada por onze módulos deste livro; a `distance`, por cinco — inclusive pelo classificador do [Capítulo 9](../cap09/index.qmd), que você talvez já tenha lido.
