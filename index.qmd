...
| 16 | 02/12 | [17 — Clustering](content/cap17/index.qmd) · revisão para a prova |
...
O [Capítulo 16 — Deep Learning](content/cap16/index.qmd) **não é coberto nas aulas deste semestre**: o assunto passou a ter disciplina própria. O capítulo continua no livro, completo e executável, e serve de leitura para quem quiser seguir adiante — ou de ponte para a disciplina de Deep Learning.
...
**A prova é individual** e cobre os fundamentos e os algoritmos construídos ao longo do semestre. A última aula, em 23/12, é a devolutiva: correção coletiva das questões, com retomada do que a turma errou mais.
